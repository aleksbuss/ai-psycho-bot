...
function navigateTo(n) {
    ...
    try {
        ...
        const titles = { chat:'Чат', video:'Медитации', music:'Дневник', game:'Дыхание', sos:'Заземление', profile:'Профиль' };
