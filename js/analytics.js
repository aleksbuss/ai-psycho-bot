...
function drawMoodChart(canvasId, days) {
    ...
    // Use canvas container width, not parent card (which has padding)
    const container = canvas.parentElement;
    const availW = container.clientWidth - 0; // canvas is already inside padded card
